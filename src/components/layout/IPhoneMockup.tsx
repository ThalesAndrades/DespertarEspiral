        ...
        >
          <div
            style={{
              ...
              borderRadius: "34px",
              padding: "10px",
              background: "linear-gradient(160deg, #20244a 0%, #090b18 55%, #14162c 100%)",
              border: "1px solid rgba(198,168,112,0.18)",
              boxShadow: [
                "0 2px 0 0 rgba(198,168,112,0.28)",
                "0 52px 100px -18px rgba(0,0,0,0.78)",
                "0 0 56px 0 rgba(198,168,112,0.10)",
                "inset 0 1px 0 rgba(198,168,112,0.16)",
              ].join(", "),
            }}
          >
            <div
            ...
            >
              <div
                ...
                style={{
                  ...
                  inset: 0,
                  background: [
                    "radial-gradient(ellipse 70% 55% at 50% 35%, rgba(198,168,112,0.18) 0%, transparent 62%)",
                    "radial-gradient(ellipse 60% 55% at 30% 75%, rgba(201,154,170,0.11) 0%, transparent 65%)",
              ...
              >
                <svg
                  ...
                  style={{
                    width: "86%",
                    maxWidth: "220px",
                    filter: "drop-shadow(0 10px 32px rgba(198,168,112,0.18))",
                  }}
